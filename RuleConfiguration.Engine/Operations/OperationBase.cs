...
public abstract class OperationBase : IOperation, IEquatable<IOperation>
{
    ...
    protected OperationBase(string name, int numberOfValues, TypeGroup typeGroups, bool active = true,
        bool supportsLists = false, bool expectNullValues = false)
    {
        Name = name;
    ...
    /// <inheritdoc />
    public abstract Expression GetExpression(MemberExpression member, ConstantExpression constant1,
